> ## ARCHIV — Legacy-Versionierung (v1.x.x)
>
> Dieses Dokument ist die **unveränderte Historie** der Beta-Entwicklung in der
> internen Zählung `v1.x.x`, wie sie vor dem Re-Baseline auf das öffentliche
> **v0.x.x-Schema** (2026-09-23, `v0.1.0`) geführt wurde. Die Legacy-Zählung
> gehört **nicht** zum öffentlichen Versionschema; `v1.73.1` ≙ `v0.1.0 (Beta)`.
>
> **Aktueller, kanonischer Changelog:** [`CHANGELOG.md`](../../CHANGELOG.md)
> im Repository-Root (enthält auch die Meilenstein-Übersicht über diese
> Historie). Neue Einträge gehören ausschließlich in die Root-Datei; dieses
> Archiv wird nicht mehr gepflegt.

---

# Changelog — Autonome KI-Trading-Firma (Legacy, v1.x.x)

> **Status-Header (Archiv):** Stand **2026-09-23** · Legacy-Code-Version **1.73.1** (≙ öffentlich `v0.1.0`, Beta). Vollständige, detaillierte Einträge je Release (Keep a Changelog + SemVer) — archiviert am 2026-09-23 mit dem Übergang auf das v0.x.x-Schema (ehemals kanonisch im Root, zuvor `docs/CHANGELOG.md` als Stub).
...
- **Dokumentation:** [`docs/STRATEGY_LIFECYCLE.md`](../STRATEGY_LIFECYCLE.md); Abschnitte in `CONFIGURATION.md` und `.env.example`.
...
- **Dokumentation:** [`docs/MONTE_CARLO.md`](../MONTE_CARLO.md) (Modell, Formeln, Einheiten, Zeitsemantik, Grenzen, Migration/Rollback); Abschnitt in `docs/BACKTESTING.md`.
...
- **Dokumentation:** [`docs/TWAP_EXECUTION.md`](../TWAP_EXECUTION.md).
...
- **Dokumentation:** [`docs/POST_ONLY_FALLBACK.md`](../POST_ONLY_FALLBACK.md), Flag-Referenz in `CONFIGURATION.md`.
...
- **Dokumentation:** [`docs/SIGNAL_DECAY.md`](../SIGNAL_DECAY.md).
...
- **Dokumentation:** neues [`docs/DRAWDOWN_SCALING.md`](../DRAWDOWN_SCALING.md) (Kurve/Stufen, Hysterese-Regeln, Equity-/Zeitsemantik, Cashflow-Erkennung, Fail-closed-Matrix, Persistenz/Idempotenz/Neustart, Observability, Composition, Migration/Rollback, Test-Matrix, Annahmen), `CONFIGURATION.md` (§ Drawdown-Risk-Scaling), `.env.example`, `docs/README.md`, Root-`README.md`.
...
- **Dokumentation:** neues [`docs/VOLATILITY_TARGETING.md`](../VOLATILITY_TARGETING.md) (Mathematik, Fail-closed-Matrix, Zeitsemantik, Annualisierung, Persistenz/Idempotenz, Observability, Migration/Rollback, Test-Matrix, Annahmen), `CONFIGURATION.md` (§ Portfolio-Volatility-Targeting), `.env.example`, `docs/README.md`.
...
- **API & Doku:** Endpunkt `GET /api/firm/devils-advocate`, Dokumentation [`docs/DEVILS_ADVOCATE.md`](../DEVILS_ADVOCATE.md), `CONFIGURATION.md`, `.env.example`.
...
- **Dokumentation:** neues [`docs/PROMPT_PERFORMANCE.md`](../PROMPT_PERFORMANCE.md) (Artefakt/Provenanz/Join/Metriken-Vergleich-Formeln/Einheiten/Zeitsemantik/API/Migration-Rollback/Observability), `CONFIGURATION.md` (§ Prompt-Performance, Flag-Tabelle), `.env.example`, Produkt-Update in `README.md`/`docs/README.md`.
...
- **Dokumentation:** [`docs/SENTIMENT.md`](../SENTIMENT.md), Aktualisierung von `docs/HANDBUCH.md`, `docs/DAILY_WEEKLY_RESEARCH.md`, `CONFIGURATION.md`, `TRACKING.md` und Finding `RMA-P2-05-structured-sentiment.md`.
...
- **Dokumentation:** neues [`docs/MTF_CONFLUENCE.md`](../MTF_CONFLUENCE.md) (Architektur, Zeitsemantik, Formeln/Einheiten, Fallbacks, Trusted-Data, Konfiguration, Observability, Migration/Rollback), `CONFIGURATION.md` (§ MTF-Konfluenz), `.env.example`, `docs/README.md`.
...
- Neues Modul-Dokument [`docs/FORECASTS.md`](../FORECASTS.md): Vertrag,
...
- **Doku:** [docs/PERPETUAL_DATA.md](../PERPETUAL_DATA.md) (Vertrag: Schema,
...
- **Dokumentation:** [docs/FEATURE_STORE.md](../FEATURE_STORE.md) (Semantik,
...
([GAP-04](../audits/2026-09-18-feature-gap/findings/GAP-04-vol-sizing-correlation-limits.md))
...
**Hintergrund:** Laut Feature-Gap-Audit 2026-09-18
([GAP-07](../audits/2026-09-18-feature-gap/findings/GAP-07-data-quality-multi-timeframe.md))
...
**Hintergrund:** Laut Feature-Gap-Audit 2026-09-18
([GAP-10](../audits/2026-09-18-feature-gap/findings/GAP-10-observability-circuit-breaker.md))
...
**Hintergrund:** Laut Feature-Gap-Audit 2026-09-18
([GAP-05](../audits/2026-09-18-feature-gap/findings/GAP-05-server-side-exit-management.md))
...
**Hintergrund:** Laut Feature-Gap-Audit 2026-09-18
([GAP-03](../audits/2026-09-18-feature-gap/findings/GAP-03-trade-journal-attribution.md))
...
**Hintergrund:** Laut Feature-Gap-Audit 2026-09-18
([GAP-02](../audits/2026-09-18-feature-gap/findings/GAP-02-execution-simulation.md))
...
- **Audit-Zyklus [`docs/audits/2026-09-18-feature-gap/`](../audits/2026-09-18-feature-gap/README.md):**
...
- Keine Code-Änderung an der Trading-Logik: Umsetzung der Lücken erfolgt
  ...
  [Prompt-Serie](../audits/2026-09-18-feature-gap/prompts/README.md)).
