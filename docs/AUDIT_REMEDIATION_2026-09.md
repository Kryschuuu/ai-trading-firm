...
**gefixt v.1.36.18**); aus der Architektur/Live-Bereitschaft sind **H2 (v1.36.19)** und
**H7 (v1.36.20)** abgeschlossen (offen: H10, W1, W2, S2).
...
**H2=v1.36.19**, **H7=v1.36.20**.
Siehe `CHANGELOG.md` und `docs/CHANGELOG.md` (`[1.36.20]`). Die Versions-Hinweise der einzelnen Befunde nennen teils noch
