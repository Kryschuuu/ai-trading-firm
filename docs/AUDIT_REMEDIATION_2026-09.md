...
3. **Control-Plane-Sicherheit:** C1 ✅ **gefixt v.1.36.13** — C2, C3, C4, S1
...
**B2 (v1.36.12)** abgeschlossen; aus der Control-Plane-Sicherheit ist **C1 (v1.36.13)**
abgeschlossen — **gefixt v.1.36.13** (C2–C4, S1 offen).
...
**C1=v1.36.13**. Siehe `CHANGELOG.md` und `docs/CHANGELOG.md` (`[1.36.13]`). Die
Versions-Hinweise der einzelnen Befunde nennen teils noch ältere Nummern (C1 ursprünglich
...
- `CHANGELOG.md` / `docs/CHANGELOG.md` — `[1.36.13]`-Eintrag
