...
**H10 (v1.36.21)** und **S2 (v1.36.22)** abgeschlossen (offen: W1, W2).
...
**H2=v1.36.19**, **H7=v1.36.20**, **H10=v1.36.21**, **S2=v1.36.22**.
Siehe `CHANGELOG.md` und `docs/CHANGELOG.md` (`[1.36.22]`). Die Versions-Hinweise der einzelnen Befunde nennen teils noch
...
- `CHANGELOG.md` / `docs/CHANGELOG.md` — `[1.36.22]`-Eintrag
