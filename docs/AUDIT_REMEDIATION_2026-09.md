...
und **H10 (v1.36.21)** abgeschlossen (offen: W1, W2, S2).
...
**H2=v1.36.19**, **H7=v1.36.20**, **H10=v1.36.21**.
Siehe `CHANGELOG.md` und `docs/CHANGELOG.md` (`[1.36.21]`). Die Versions-Hinweise der einzelnen Befunde nennen teils noch
