...
3. **Control-Plane-Sicherheit:** C1 ✅ **gefixt v.1.36.13** — C2 ✅ **gefixt v.1.36.14** — C3 ✅ **gefixt v.1.36.15** — C4, S1
...
**gefixt v.1.36.13** — **C2 (v1.36.14)** — **gefixt v.1.36.14** — und **C3 (v1.36.15)** —
**gefixt v.1.36.15** — abgeschlossen (C4, S1 offen).
...
**C1=v1.36.13**, **C2=v1.36.14**, **C3=v1.36.15**. Siehe `CHANGELOG.md` und `docs/CHANGELOG.md`
(`[1.36.15]`). Die Versions-Hinweise der einzelnen Befunde nennen teils noch ältere Nummern (C1–C3
ursprünglich `1.36.3`) — maßgeblich ist die Serie oben.
...
- `CHANGELOG.md` / `docs/CHANGELOG.md` — `[1.36.15]`-Eintrag
