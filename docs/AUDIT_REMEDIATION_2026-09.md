...
**B2 (v1.36.12)** abgeschlossen.

## Versionierung

Tracking als PATCH-Serie (Security-Audit-Plan + Fixes): H1=v1.36.2, H3=v1.36.4, H4=v1.36.5,
H5=v1.36.6, H6=v1.36.7, H9=v1.36.8, **H8=v1.36.10**, **B1=v1.36.11**, **B2=v1.36.12**. Siehe
`CHANGELOG.md` und `docs/CHANGELOG.md` (`[1.36.12]`).
...
- `CHANGELOG.md` / `docs/CHANGELOG.md` — `[1.36.12]`-Eintrag
