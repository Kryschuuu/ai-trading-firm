...
5. **Workshop:** W1 ✅ **gefixt v.1.36.23** — W2
...
**H10 (v1.36.21)**, **S2 (v1.36.22)** und **W1 (v1.36.23)** abgeschlossen (offen: W2).
...
**H2=v1.36.19**, **H7=v1.36.20**, **H10=v1.36.21**, **S2=v1.36.22**, **W1=v1.36.23**.
Siehe `CHANGELOG.md` und `docs/CHANGELOG.md` (`[1.36.23]`). Die Versions-Hinweise der einzelnen Befunde nennen teils noch
...
- `CHANGELOG.md` / `docs/CHANGELOG.md` — `[1.36.23]`-Eintrag
