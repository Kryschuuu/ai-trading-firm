...
**Datum:** 2026-09-05  
**Status:** OPEN — SEC-01 FIXED in v1.36.27, SEC-02 FIXED in v1.36.31, SEC-03 FIXED in v1.36.28, SEC-10 FIXED in v1.36.29, SEC-04 FIXED in v1.36.30, SEC-07 FIXED in v1.36.32, SEC-05 FIXED in v1.36.33 (2026-09-06); übrige Findings weiter offen
...
| SEC-05 | Fälschbare Akteursattribution bei Rule-Änderungen | MEDIUM | FIXED | v1.36.33 | [SEC-05](./findings/SEC-05-rule-actor-attribution.md) |
...
1. **SEC-01 erledigt (v1.36.27):** unabhängiger Session-Key, aktuelle serverseitige
   ...
   **SEC-05 erledigt (v1.36.33):** Audit-Attribution von Regel-Änderungen ausschließlich aus dem authentifizierten Credential.
2. **Vor weiterem Live-Ausbau:** SEC-07 erledigt (v1.36.32) — kein Env-Fallback in Prod
3. **Vor echter Multi-Role-Nutzung:** SEC-05 erledigt (v1.36.33) — verbleibend SEC-06 (Rule-Permissions)
