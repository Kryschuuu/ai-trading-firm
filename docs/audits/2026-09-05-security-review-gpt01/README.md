...
**Datum:** 2026-09-05  
**Status:** OPEN — SEC-01 FIXED in v1.36.27, SEC-02 FIXED in v1.36.31, SEC-03 FIXED in v1.36.28, SEC-10 FIXED in v1.36.29, SEC-04 FIXED in v1.36.30, SEC-07 FIXED in v1.36.32, SEC-05 FIXED in v1.36.33 (ergänzt v1.36.34), SEC-06 FIXED in v1.36.34 (2026-09-06), SEC-08 FIXED in v1.36.35 (2026-09-07); SEC-09 weiter offen
...
Die wichtigsten Punkte sind nicht klassische SQL-Injection oder Kryptographiefehler, sondern **Authorization-/Trust-Boundary-Probleme und unnötig öffentliche Datenzugriffe**. SEC-02 ist seit v1.36.31 geschlossen, SEC-07 seit v1.36.32, SEC-05 seit v1.36.33 (Erstellungsattribution ergänzt in v1.36.34), SEC-06 seit v1.36.34, SEC-08 seit v1.36.35; beide Dependency-Befunde sind ebenfalls behoben: `next` seit v1.36.28, `ws` seit v1.36.30.
...
3. **Vor echter Multi-Role-Nutzung:** SEC-05/SEC-06/SEC-08 erledigt — v1.36.35 ausrollen und verschiedene Admin-/Operator-Credentials konfigurieren
4. **Danach:** SEC-09 (Memory-Hygiene-Doku); SEC-10 (Actions-SHAs) bereits erledigt

SEC-08 ist vollständig behoben (v1.36.35): individuelles Logout/Revoke sowie globale Revocation stehen bereit.
