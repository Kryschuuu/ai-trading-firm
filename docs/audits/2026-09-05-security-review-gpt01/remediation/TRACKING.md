...
| SEC-09 | Memory-Hygiene schützt JS-Strings nicht wirklich | LOW | FIXED | v1.36.36 | arena/01a07b95-ai-trading-firm (PR folgt) | - | Ehrliche JS-String-Grenze in Code+Doku, `zeroize` auf Krypto-Buffern erhalten, `disposeCredential` verwirft Referenzen, Betriebs-Hinweise (kein Inspector, keine Heap-/Core-Dumps) |
