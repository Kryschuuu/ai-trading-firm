...
| RMA-P4-01 | Execution-Benchmarking | PARTIAL | [P4-01](../prompts/PROMPT-P4-01-execution-benchmarking.md) | — | — | — | Ledger/Import/Read-API teilimplementiert; automatische Broker-/Backtest-Anbindung offen, keine Fix-Version |
