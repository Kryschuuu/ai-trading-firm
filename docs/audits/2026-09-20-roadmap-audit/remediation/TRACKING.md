...
| 2 | [RMA-P1-02](../findings/RMA-P1-02-walk-forward-training.md) | FIXED (v1.60.0) | IS-only Train-Select-Freeze, OOS mit eingefrorener ID, finaler Holdout, append-only Freeze-Artefakte |
...
| RMA-P1-02 | 90d/30d Walk-Forward | FIXED | [P1-02](../prompts/PROMPT-P1-02-walk-forward-training.md) | [#157](https://github.com/Kryschuuu/ai-trading-firm/pull/157) | `10e83f3` (inkl. `a0e17df`) | v1.60.0 | `tests/backtest.walkforward.training.test.ts` (5), gezielte Backtest-/Ledger-Regression (48 pass, 11 DB-Skips), typecheck/lint/docs:validate grün; `npm test` auf Nutzeranweisung übersprungen |
