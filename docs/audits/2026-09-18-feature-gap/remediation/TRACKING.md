...
| GAP-02 | Realistische Execution-Simulation (Slippage/Fees/**Funding**) | ★★★★★ | FIXED | 1.42.0 | `arena/01a0b48a-ai-trading-firm` | D1–D4 umgesetzt (Funding-Accrual im Monitor-Tick, `positions.funding_paid`, Kalibrierungs-Flags, Determinismus-Tests); Rate-Default 0 = neutral. Offen: echte Funding-Raten-Anbindung (Provider-Interface vorhanden) | [PROMPT-02](../prompts/PROMPT-02-execution-simulation.md) |
| GAP-03 | Trade-Journal mit Agenten-Attribution & Feedback-Loop | ★★★★★ | OPEN | — | — | Rohdaten (mission/rule/proposals/audit) vorhanden; Delta = Verknüpfung + Auswertung + begrenzte Rückführung | [PROMPT-03](../prompts/PROMPT-03-trade-journal-attribution.md) |
...
| GAP-05 | Server-seitiges Exit-Management (Trailing/Time-Stop/OCO) | ★★★★★ | OPEN | — | — | SL/TP-Watcher existiert (`monitor.tick`); Delta = Trailing + Time-Stop + OCO-Exklusivität | [PROMPT-05](../prompts/PROMPT-05-server-side-exit-management.md) |
