/**
 * SecretStore-Interface fuer den Bitunix-Adapter.
 *
 ...
 * `BITUNIX_API_KEY` / `BITUNIX_API_SECRET` nur noch in explizitem
 * Dev/Test-Modus hinter `BROKER_ALLOW_ENV_FALLBACK=true`. Niemals
 * Disk-Klartext, niemals Frontend. Siehe docs/BITUNIX.md.
 */
import {
 ...
 * Produktion nutzt `createDefaultBitunixSecretStore` (verschluesselter
