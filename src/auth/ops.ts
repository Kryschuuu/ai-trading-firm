...
import { docCanonicalPath } from "@/lib/docsCatalog";
import { APP_VERSION } from "@/lib/version";

/** Kanonische Doku-URL eines Katalog-Slugs (mit Fallback auf den Slug-Link). */
function docHref(slug: string): string {
  return docCanonicalPath(slug) ?? `/docs?name=${slug}`;
}
