...
> H1 ist z. B. bereits in **v1.36.2** gefixt, B2 in **v1.36.12**, C1 in **v1.36.13**. Jeder Prompt
> trägt daher einen **Status (validiert)**, der angibt, ob der Befund im aktuellen Code noch
> zutrifft.

## Validierungsübersicht (Stand 2026-09-03, main @ a29e956 · Fixes bis v1.36.13)
...
**H8=v1.36.10**, **B1=v1.36.11**, **B2=v1.36.12**, **C1=v1.36.13**.
Siehe `CHANGELOG.md` und `docs/CHANGELOG.md` (`[1.36.13]`). Jeder einzelne Fix ist als eigener
