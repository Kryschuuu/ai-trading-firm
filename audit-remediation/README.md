...
> H2 in **v1.36.19**, H7 in **v1.36.20**, H10 in **v1.36.21**, S2 in **v1.36.22**. Jeder Prompt trägt daher einen **Status (validiert)**, der angibt, ob der
> Befund im aktuellen Code noch zutrifft.

## Validierungsübersicht (Stand 2026-09-05 · Fixes bis v1.36.22)
...
**H10=v1.36.21**, **S2=v1.36.22**.
Siehe `CHANGELOG.md` und `docs/CHANGELOG.md` (`[1.36.22]`). Jeder einzelne Fix ist als eigener
