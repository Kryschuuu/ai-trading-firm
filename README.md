...
**Version: v0.3.0 (Beta)** · [Changelog](CHANGELOG.md) · [Versions-Metadaten](VERSION.md) · [Beitragen](CONTRIBUTING.md) · [Lizenz: GPL-3.0-only](LICENSE)
...
| Feld | Wert |
| --- | --- |
| Version | **v0.3.0** (Beta, 2026-09-24; Baseline war v0.1.0) |
...
├── package.json              ← Version-SSoT (v0.3.0), Scripts, Abhängigkeiten
